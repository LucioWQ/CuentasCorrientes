	...
	<body>
        <div class="container">
	        ...
	        <div id="cont">
	           ...
	           <a href="logout" class="btn btn-danger" role="button" id="salirSesion">Salir</a>   
            
            	<a href='#myModalNorm' data-toggle='modal' data-target='#myModalNorm' class="btn btn-success openmodal" role="button" id="nuevo"> + Producto</a>
            </div>
            ...
            <a href="index.jsp" title="Volver a inicio">	<i style="font-size:60px" class="fa">&#xf015;</i></a>
        </div>
