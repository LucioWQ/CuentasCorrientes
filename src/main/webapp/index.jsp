...
<header class="cd-header">
		...
		<nav class="cd-primary-nav">
			<ul>
				...
				<li><a href="iniciarSesion">Ingresar</a></li>
				<li><a href="registrarUsuario">Registrarse</a></li>
				
			</ul>
		</nav>
	</header>
	<section id="cd-intro" data-stellar-background-ratio="0.5">
		<div id="cd-intro-tagline">
			<h1>Mira nuestro catalogo!${personaSesion.email}</h1>
			<a href="vistaProducto" class="cd-btn">Productos &amp; Precios</a>
		</div> 
	</section> 
